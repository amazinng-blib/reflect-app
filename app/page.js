  ...
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16 ">
      ...
      <div className="relative">
        ...
        <div className="bg-white rounded-2xl p-4 max-full mx-auto mt-4">
          ...
          <div className="space-y-4 p-4">
            <h3 className="text-center text-xl font-semibold text-orange-900">
      ...
      <div className="my-12 flex justify-center gap-4">
        ...
        <Link href={'#features'}>
          <Button
            variant="outline"
            className="px-8 py-6 rounded-full border-orange-600  hover:bg-orange-100"
          >
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-6">
            ...
            <p className="text-lg text-orange-700">
              Express yourself with our powerful editor featuring:
            </p>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-4 bg-white rounded-2xl shadow-xl p-6 border border-orange-100">
            ...
            <div className="flex justify-between">
              <div className={'h-4 w-16 bg-orange-100 '} />
              <div className={'h-4 w-16 bg-orange-100'} />
              <div className={'h-4 w-16 bg-orange-100'} />
            </div>
          </div>
      ...
      <div className="mt-24">
        ...
        <Accordion type="single" collapsible className="w-full mx-auto">
          {faqs?.map((faq, index) => {
            return (
              <AccordionItem value={`item-${faq.q}`} key={faq.q}>
      ...
      <div className="mt-24">
        <Card className="bg-gradient-to-r from-orange-100 to-amber-100">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-orange-700 mb-8 text-lg mx-auto max-w-2xl">
